...
export const Header = () => {
  ...
  const activeClass = "text-base block py-2 pr-4 pl-3 text-white bg-blue-700 md:bg-transparent md:text-orange-500 md:p-0 dark:text-orange-500";
  const inActiveClass = "text-base block py-2 pr-4 pl-3 text-gray-500 rounded-lg hover:bg-gray-100 md:hover:bg-transparent md:hover:text-orange-500 md:p-0 md:dark:hover:text-orange-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700";
        ...
        <div className="flex flex-wrap justify-between items-center mx-auto">
          ...
          <button onClick={() => setDarkMode(!darkMode)} data-tooltip-target="navbar-search-example-toggle-dark-mode-tooltip" type="button" data-toggle-dark="light" className="flex items-center p-2 mr-2 text-xs font-medium text-gray-700 bg-white rounded-lg toggle-dark-state-example hover:bg-gray-100 hover:text-gray-700 focus:z-10 focus:ring-2 focus:ring-orange-300 dark:focus:ring-orange-500 dark:bg-gray-800 focus:outline-none dark:text-gray-400 dark:border-orange-600 dark:hover:text-white dark:hover:bg-gray-700">
            ...
            <div className={`${hidden ? "hidden" : ""} justify-between items-center w-full md:flex md:w-auto md:order-1`} id="navbar-search">
              <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-orange-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-900 md:dark:bg-gray-900 dark:border-orange-700">
                <li>
