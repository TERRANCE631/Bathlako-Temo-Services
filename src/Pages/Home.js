...
export const Home = ({title}) => {
    ...
    return(
        <main>
            <div className="mb-8 relative h-screen bg-cover bg-center" style={{ backgroundImage: `url(${bg_2})` }}>
            {/* Overlay */}
                ...
                <div className="relative z-10 flex items-center justify-center h-full text-center px-4 sm:px-6">
                    <div className="max-w-lg md:max-w-2xl lg:max-w-4xl">
                        <h1 className="text-4xl font-extrabold text-white sm:text-5xl md:text-6xl lg:text-7xl">
                            Quality Citrus Fruits <span className="text-orange-500">Grown with Passion</span>
                        </h1>
            ...
            <section class="my-auto mx-auto pt-20 bg-transparent dark:bg-transparent">
                <h5 className="text-center -mt-16 mb-4 text-gray-700 dark:text-gray-300 pb-5 text-3xl font-bold">Our cultivars</h5>
                <div class="px-10 mx-auto rounded-lg border-gray-900 max-w-screen-xl lg:py-4 flex justify-center">
                    <div class="grid md:grid-cols-3 gap-4">
                        <div class="bg-gray-50 dark:bg-gradient-to-t from-gray-800 to-transparent shadow-xl dark:bg-gray-700 border border-gray-200 dark:border-gray-500 p-2 md:p-2">
                                <img className="w-60 flex justify-evenly mx-auto" src={Eureka} alt="" />
                        ...
                        <div class="bg-gray-50 dark:bg-gradient-to-t from-gray-800 to-transparent shadow-lg dark:bg-gray-700 border border-gray-200 dark:border-gray-500 p-2 md:p-2">
                                    <img className="w-60 flex justify-evenly mx-auto" src={mandarin} alt="" />
                        ...
                        <div class="bg-gray-50 dark:bg-gradient-to-t from-gray-800 to-transparent shadow-xl dark:bg-gray-700 border border-gray-200 dark:border-gray-500 p-2 md:p-2">
                                <img className="w-60 flex justify-evenly mx-auto" src={ Nova } alt="" />
                ...
                <section className="my-10">
                    <h5 className="text-center text-gray-700 dark:text-gray-300 pb-5 text-3xl font-bold">Gallery</h5>
                    ...
                    <div className="container mx-auto px-4 py-4">
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                            ...
                            <div className="w-full h-48 sm:h-52 lg:h-30 transform hover:scale-105 transition-transform duration-300">
                                <img src={img5} alt="Gallery Image 5" className="w-full h-full object-cover" />
                            </div>
                            <div className="w-full h-48 sm:h-52 lg:h-30 transform hover:scale-105 transition-transform duration-300">
                                <img src={img6} alt="Gallery Image 6" className="w-full h-full object-cover" />
                            </div>
                            <div className="w-full h-48 sm:h-52 lg:h-30 transform hover:scale-105 transition-transform duration-300">
                                <img src={img7} alt="Gallery Image 6" className="w-full h-full object-cover" />
                            </div>
                            <div className="w-full h-48 sm:h-52 lg:h-30 transform hover:scale-105 transition-transform duration-300">
                                <img src={img12} alt="Gallery Image 6" className="w-full h-full object-cover" />
                            </div>
                            <div className="w-full h-48 sm:h-52 lg:h-30 transform hover:scale-105 transition-transform duration-300">
                                <img src={img13} alt="Gallery Image 6" className="w-full h-full object-cover" />
                            </div>
                            <div className="w-full h-48 sm:h-52 lg:h-30 transform hover:scale-105 transition-transform duration-300">
                                <img src={welcome} alt="Gallery Image 6" className="w-full h-full object-cover" />
                            </div>
                        </div>
                    </div>
                </section>
